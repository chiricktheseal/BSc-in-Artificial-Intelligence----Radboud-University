...
/*!
  ...
  value. The given options has to be already registered.

  \se None
  \sa OptsHandler_is_option_registered
*/
int
...
/*!
  ...
  The given options has to be already registered.
...
/*!
  ...
  Returns the default value of a boolean option value.
