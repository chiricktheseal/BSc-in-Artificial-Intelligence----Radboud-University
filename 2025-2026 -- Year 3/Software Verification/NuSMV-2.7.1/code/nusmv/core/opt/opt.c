...
/******************************************************************************/
/* EXPAND_WORDARRAYS */
void set_expand_wordarrays(OptsHandler_ptr opt)
{
  boolean res = OptsHandler_set_bool_option_value(opt, EXPAND_WORDARRAYS, true);
  nusmv_assert(res);
}
void unset_expand_wordarrays(OptsHandler_ptr opt)
{
  boolean res = OptsHandler_reset_option_value(opt, EXPAND_WORDARRAYS);
  nusmv_assert(res);
}
boolean opt_expand_wordarrays(OptsHandler_ptr opt)
{
  return OptsHandler_get_bool_option_value(opt, EXPAND_WORDARRAYS);
}
