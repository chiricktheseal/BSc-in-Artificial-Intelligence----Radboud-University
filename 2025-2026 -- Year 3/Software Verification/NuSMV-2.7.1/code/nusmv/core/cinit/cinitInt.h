...
/*!
  \brief Returns whether NuSMV is built in debug or release mode

  Return true if the NuSMV tool is compiled in release mode
  Return false if the NuSMV tool is compiled in debug mode

  This command gives informations only about the NuSMV compilation
  and does not give guaranties about how are compiled the other tools
  using it.
  Anyway, if the other tools are built using the building system, the compilation
  can be considered uniform.
*/
boolean CInit_print_tool_compilation_mode();
