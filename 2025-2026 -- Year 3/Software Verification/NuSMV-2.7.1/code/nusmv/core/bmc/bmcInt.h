...
/*!
  ...
  Fills the trace. The trace will be a k steps long trace in the
                language of \"symbols\" out a cnf model from a sat
                solver. In case of complete_trace = TRUE the trace 
                is complete.
