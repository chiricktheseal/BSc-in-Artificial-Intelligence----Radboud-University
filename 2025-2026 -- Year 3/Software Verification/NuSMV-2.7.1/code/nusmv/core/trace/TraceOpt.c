...
static void trace_opt_update_from_env(TraceOpt_ptr self,
...
TraceOpt_ptr TraceOpt_create_from_env(const NuSMVEnv_ptr env)
{
  ...
  trace_opt_update_from_env(self, env);
  return self;
}
...
/*!
  ...
  This is an auxiliary method of TraceOpt_create_from_env
*/
static void trace_opt_update_from_env(TraceOpt_ptr self, const NuSMVEnv_ptr env)
{
  ...
  /* This function can only be called from TraceOpt_create_from_env */
  nusmv_assert(OStream_get_stream(self->output_stream) ==
