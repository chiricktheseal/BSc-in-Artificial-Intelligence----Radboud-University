...
void TracePlugin_print_transition(const TracePlugin_ptr self, int step)
{
  TRACE_PLUGIN_CHECK_INSTANCE(self);
  self->print_transition(self, step);
}

void TracePlugin_print_trace_info(const TracePlugin_ptr self)
{
  TRACE_PLUGIN_CHECK_INSTANCE(self);
  self->print_trace_info(self);
}
...
void trace_plugin_print_trace_info(const TracePlugin_ptr self)
{
}


void trace_plugin_print_transition(const TracePlugin_ptr self, int step)
{
}
...
void trace_plugin_init(TracePlugin_ptr self, char* desc)
{
  ...
  OVERRIDE(TracePlugin, print_trace_info) = trace_plugin_print_trace_info;
  OVERRIDE(TracePlugin, print_transition) = trace_plugin_print_transition;
...
boolean trace_plugin_is_visible_symbol(TracePlugin_ptr self, node_ptr symb)
{
  ...
  res = TracePkg_is_visible_symbol(env, self->opt, symb);
