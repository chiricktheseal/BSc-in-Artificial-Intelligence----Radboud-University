...
/*!
  ...
  Prints on the specified file the flatten
   ...
   constrains (INIT, TRANS, INVAR, ASSIGNS, URGENT,
               JUSTICE, COMPASSION).
                                       ...
                                       hash_ptr dag_info, hash_ptr defines)
{
  ...
  if (compile_write_udg_flatten_expr_split(env, symb_table, out,
                                           FlatHierarchy_get_urgent(hierarchy),
                                           URGENT_T,
                                           dag_info,
                                           defines)) fprintf(out, "\n");
  fprintf(out, "]\n");
                                       ...
                                       hash_ptr dag_info, hash_ptr defines)
{
  ...
  if (compile_write_udg_flatten_expr_split(
          env, symb_table, out,
          SexpFsm_get_urgent(SEXP_FSM(bool_sexp_fsm)),
          URGENT_T, dag_info, defines)) {
    fprintf(out, "\n");
  }
                                           ...
                                           BddEnc_ptr enc)
{
  ...
  Compile_make_dag_info(env, FlatHierarchy_get_urgent(hierarchy), dag_info);
  Compile_make_dag_info(env, FlatHierarchy_get_justice(hierarchy), dag_info);
  Compile_make_dag_info(env, FlatHierarchy_get_compassion(hierarchy), dag_info);
                                        ...
                                        const char* style)
{
  ...
  case TIME: return _PRINT(n, "time", "", "");
...
static void compile_write_print_node_type(FILE* buffer, node_ptr node)
{
  ...
  case URGENT: fprintf(buffer, "URGENT"); break;
  ...
  case SPEC: fprintf(buffer, "SPEC"); break; /* 110 */
  case LTLSPEC: fprintf(buffer, "LTLSPEC"); break;
  case PSLSPEC: fprintf(buffer, "PSLSPEC"); break;
  ...
  case MODTYPE: fprintf(buffer, "MODTYPE"); break; /* 120 */
  case LAMBDA: fprintf(buffer, "LAMBDA"); break;
  ...
  case CONTEXT: fprintf(buffer, "CONTEXT"); break; /* 130 */
  ...
  case BOOLEAN: fprintf(buffer, "BOOLEAN"); break; /* 140 */
  case ARRAY: fprintf(buffer, "ARRAY"); break;
  ...
  case RB: fprintf(buffer, "RB"); break; /* 150 */
  ...
  case TIME: fprintf(buffer, "TIME"); break;
  case SELF: fprintf(buffer, "SELF"); break;
  case CASE: fprintf(buffer, "CASE"); break;
  case ESAC: fprintf(buffer, "ESAC"); break; /* 160 */
  case COLON: fprintf(buffer, "COLON"); break;
  case IFTHENELSE: fprintf(buffer, "IFTHENELSE"); break;
  ...
  case COMMA: fprintf(buffer, "COMMA"); break; /* 170 */
  ...
  case EF: fprintf(buffer, "EF"); break; /* 180 */
  case AF: fprintf(buffer, "AF"); break;
  case EG: fprintf(buffer, "EG"); break;
  ...
  case EBG: fprintf(buffer, "EBG"); break; /* 190 */
  ...
  case OP_NOTPRECNOT: fprintf(buffer, "OP_NOTPRECNOT"); break; /* 200 */
  case OP_HISTORICAL: fprintf(buffer, "OP_HISTORICAL"); break;
  ...
  case SETIN: fprintf(buffer, "SETIN"); break; /* 210 */
  ...
  case BIT: fprintf(buffer, "BIT"); break; /* 220 */
  case RANGE: fprintf(buffer, "RANGE"); break;
  ...
  case CLOCK: fprintf(buffer, "CLOCK"); break;
  ...
  case NUMBER_REAL: fprintf(buffer, "NUMBER_REAL"); break; /* 230 */
  case NUMBER_EXP: fprintf(buffer, "NUMBER_EXP"); break;
  case LSHIFT: fprintf(buffer, "LSHIFT"); break;
  ...
  case CAST_SIGNED: fprintf(buffer, "CAST_SIGNED"); break; /* 240 */
  ...
  case CAST_TOINT: fprintf(buffer, "CAST_TOINT"); break;  /* 250 */
