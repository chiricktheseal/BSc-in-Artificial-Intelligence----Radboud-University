...
/*!
  ...
  \todo Missing description
*/
#define ENV_SYMB_TABLE_CLOCK_TYPE "symb_table_clock_type"
...
/*!
  ...
  \todo Missing description
*/
#define ENV_SYMB_TABLE_REAL_SET_TYPE "symb_table_real_set_type"
...
void SymbTablePkg_init(NuSMVEnv_ptr env)
{
  ...
  */
  ...
  NuSMVEnv_set_value(env, ENV_SYMB_TABLE_CLOCK_TYPE,
                     SymbType_create_memory_sharing_type(env, SYMB_TYPE_CLOCK, Nil));
  ...
  NuSMVEnv_set_value(env, ENV_SYMB_TABLE_REAL_SET_TYPE,
                     SymbType_create_memory_sharing_type(env, SYMB_TYPE_SET_REAL, Nil));
...
SymbType_ptr SymbTablePkg_clock_type(const NuSMVEnv_ptr env)
{
  return GET_TYPE(env, ENV_SYMB_TABLE_CLOCK_TYPE);
}

SymbType_ptr SymbTablePkg_clock_inner_type(const NuSMVEnv_ptr env)
{
  nusmv_assert(NuSMVEnv_has_value(env, ENV_TIME_DOMAIN));
  switch((TimeDomain)NuSMVEnv_get_value(env, ENV_TIME_DOMAIN)){
  case TIMED_DISCRETE:
    return SymbTablePkg_integer_type(env);
  case TIMED_CONTINUOUS:
...
SymbType_ptr SymbTablePkg_real_set_type(const NuSMVEnv_ptr env)
{
  return GET_TYPE(env, ENV_SYMB_TABLE_REAL_SET_TYPE);
}
