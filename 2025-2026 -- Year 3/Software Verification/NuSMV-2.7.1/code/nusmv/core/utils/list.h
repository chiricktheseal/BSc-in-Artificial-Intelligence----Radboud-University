...
/*!
  \brief Arbitrary pointer to const data
*/
typedef const void* lsConstGeneric;
...
*/
lsStatus lsSort(lsList, int (*compare)(lsConstGeneric, lsConstGeneric));
...
/*!
 ...
 is required.
*/
lsStatus lsUniq(lsList, int (*compare)(lsConstGeneric, lsConstGeneric),
