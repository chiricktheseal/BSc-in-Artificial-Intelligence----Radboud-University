...
SexpFsm_ptr SexpFsm_create_predicate_normalised_copy(const SexpFsm_ptr self,
                                                     MasterCompilePredicateNormaliser_ptr normaliser);
...
/*!
  \methodof SexpFsm
  \brief Returns an Expr that collects all urgent states for all
  variables handled by self


*/
Expr_ptr SexpFsm_get_urgent(const SexpFsm_ptr self);
