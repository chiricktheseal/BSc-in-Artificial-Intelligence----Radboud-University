...
/*!
  \methodof HrcNode
  \brief Remove a frozen function from the current node

  The symbol table is not modified.
  Linear in the number of frozen functions
*/
...
/*!
  \methodof HrcNode
  \brief Replaces the URGENT expressions for the current
  node.

  Replaces the URGENT expressions for the current
  node.
...
/*!
  \methodof HrcNode
  \brief Sets the URGENT expressions for the current node.

  Sets the URGENT expressions for the current
  node. It is a possibly empty list of implicitly conjoined expressions.
...
/*!
  \methodof HrcNode
  \brief Adds an URGENT expression to the current node.

  Adds an URGENT expression to the current node.
...
/*!
  \methodof HrcNode
  \brief Replaces the list of PREDs.

  Replaces the list of PRED.
...
/*!
  \methodof HrcNode
  \brief Gets the list of PREDs.

  Gets the list of PREDs.
...
/*!
  \methodof HrcNode
  \brief Adds a PRED to the list of
  PREDs.

  Adds a PRED to the list of
  PREDs.
...
/*!
  \methodof HrcNode
  \brief Replaces the list of MIRRORs.

  Replaces the list of MIRROR.
...
/*!
  \methodof HrcNode
  \brief Gets the list of MIRRORs.

  Gets the list of MIRRORs.
...
/*!
  \methodof HrcNode
  \brief Adds a MIRROR to the list of
  MIRRORs.

  Adds a MIRROR to the list of
  MIRRORs.
...
/*!
  \methodof HrcNode
  \brief Replaces the list of param SYNTH problems.

  Warning: this is meant to eventually move into nuxmv
  \se Structure is updated
*/
void HrcNode_replace_psynth_problems(HrcNode_ptr self, Olist_ptr psynth_probs);

/*!
  \methodof HrcNode
  \brief Returns an iterator of the list of parameter synthesis problems.
...
/*!
  \methodof HrcNode
  \brief Adds a param synth problem.

  \se Structure is updated
*/
void HrcNode_add_psynth_problem(HrcNode_ptr self, node_ptr psynth_prob);

/*!
  \methodof HrcNode
  \brief Replaces the list of KLTL problems.
...
/*!
  \methodof HrcNode
  \brief Returns an iterator of the list of KLTL problems.
...
/*!
  \methodof HrcNode
  \brief Replaces the list of property_pattern expr.
...
/*!
  \methodof HrcNode
  \brief Returns an iterator of the list of property pattern expressions.
