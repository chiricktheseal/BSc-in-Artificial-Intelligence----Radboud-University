...
typedef struct HrcNode_TAG
{
  ...
  Olist_ptr urgent_expr;       /* init expression URGENT */
  Olist_ptr urgent_assign;     /* init assignements x :=.. */
  Olist_ptr justice;           /* JUSTICE/FAIRNESS */
  Olist_ptr compassion;        /* COMPASSION */
  Olist_ptr constants;         /* CONSTANTS */
  Olist_ptr predicates;        /* PRED */
  Olist_ptr mirrors;           /* MIRROR */
  ...
  Olist_ptr psynth_probs;      /* SYNTH */
  Olist_ptr kltl_probs;        /* KLTL */
  Olist_ptr property_patterns; /* DEFINE_PROPERTY */
