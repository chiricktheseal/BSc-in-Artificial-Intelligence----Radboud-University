...
Possible values are \varvalue{classic} (i.e. k-induction with k=1) and \varvalue{een-sorensson}.
...
\begin{nusmvVar} {sat\_solver}{\set{SAT Solver}{\minisat}}{\minisat}
...
symbols as \code{DEFINE}s that do not carry any useful information
