...
def generate_test(
    ...
    if use_known_strategy and class_name == 'Stone':
        ...
        if stone_methods:
          selected_method = random.choice(stone_methods)
          method, arg_types, return_type = selected_method
        ...
        for j, arg_type in enumerate(arg_types):        
            ...
            var_name = f"var_{obj_id}_{method}"
        ...
        if end_methods:
            ...
            selected_method = random.choice(end_methods)
            method, arg_types, return_type = selected_method
        ...
        if game_methods:
            method, arg_types, return_type = random.choice(game_methods)
        ...
        if other_methods:
            method, arg_types, return_type = random.choice(other_methods)
...
if __name__ == "__main__":
    ...
    write_unittest_file(tests, args.input_file, "tests_single.py")
