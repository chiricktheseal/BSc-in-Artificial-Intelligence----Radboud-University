...
/* name associated to the DependencyCore node walker */
#define DEPENDENCY_CORE_NAME "Dependency core"
...
/*!
  ...
  Implementation of virtual method get_dependencies
  for DependencyCore class.

  \sa DependencyBase_get_dependencies
*/
