...
typedef struct CheckerBase_TAG
{
  ...
  void (*print_operator)(const CheckerBase_ptr self, FILE* output_stream,
                         const node_ptr expr);
...
/*!
  \methodof CheckerBase
  \brief The CheckerBase class copy constructor

  The CheckerBase class private copy constructor.
...
/*!
  \methodof CheckerBase
  \brief Virtual protected method for printing the operator
*/
