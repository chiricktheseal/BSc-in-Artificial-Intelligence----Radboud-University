...
/*!
  \brief Name of problem database in the environment
*/
#define ENV_PROBLEM_DB         "+@_problem_db"

/*!
  \brief Name of problem database in the environment
*/
#define ENV_BOOLEANIZEABLE_TYPE         "+A_booleanize_hash"
/* next ascii is "B" */

/*!
  \brief name of the time domain of the current module in the environment

  The value stored under this name is of type 'TimeDomain'
*/
/*  NOTE: To be moved to nuXmv when the revised modular/extensible compiler will be in place */
#define ENV_TIME_DOMAIN "env_time_domain_type"

/*!
  \brief type of time for the model

  UNTIMED: variable type Clock is not allowed in the model
  TIMED_DISCRETE: Clock variables represent discrete time
  TIMED_CONTINUOUS: Clock variables represent continuous time.
*/
typedef enum {
  TIME_ERROR = -1,
  UNTIMED = 1,
