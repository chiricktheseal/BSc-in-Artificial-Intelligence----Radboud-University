...
/*!
  \methodof NodeWalker
  \brief The NodeWalker class copy constructor

  The NodeWalker class private copy constructor.
  ...
  \sa Object_copy
*/
void node_walker_copy_aux(const NodeWalker_ptr self, NodeWalker_ptr other);
