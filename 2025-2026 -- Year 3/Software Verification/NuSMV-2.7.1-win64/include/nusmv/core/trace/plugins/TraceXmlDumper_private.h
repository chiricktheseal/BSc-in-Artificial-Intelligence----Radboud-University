...
/*!
  ...
  \todo
*/
void trace_xml_dumper_print_functions(TracePlugin_ptr self,
                                      node_ptr symb, node_ptr val);
/*!
  \methodof TraceXmlDumper

  Print trace info: type, id, desc.
*/
void trace_xml_dumper_print_trace_info(const TracePlugin_ptr self);
