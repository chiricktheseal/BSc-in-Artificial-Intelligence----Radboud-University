...
if __name__ == '__main__':
    ...
    # Determine your elimination ordering before you call the run function. 
    # The elimination ordering is either specified by a list or a heuristic function that determines the elimination ordering given the network. 
    # --Experimentation with different heuristics will earn bonus points. 
    # The elimination ordering can for example be set as follows:
    ...
    ve.run(query, evidence, elim_order) #run variable_elimination for node based on evidence and elimination order
