...
def get_players(game_n: int) -> List[PlayerController]:
    ...
    minmax1: PlayerController = MinMaxPlayer(1, game_n, 5, heuristic1)
    minmax2: PlayerController = MinMaxPlayer(2, game_n, 4, heuristic2)
    
    alphabeta1: PlayerController = AlphaBetaPlayer(1, game_n, 4, heuristic1)
    alphabeta2: PlayerController = AlphaBetaPlayer(2, game_n, 5, heuristic2)
...
if __name__ == '__main__':
    ...
    height: int = 20 # height of the board
